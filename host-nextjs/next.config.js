...
const APP_REMOTE_REACT_CRACO =
  process.env.APP_REMOTE_REACT_CRACO || "http://localhost:3003";
...
const remotes = (isServer) => {
  ...
  return {
    ...
    remote_react_craco: `remote_react_craco@${APP_REMOTE_REACT_CRACO}/remoteEntry.js`,
  };
};
